...
public class Car extends Observable {//Sadly the only thing
    ...
    public Car() {
        ...
        this.colorCost.put("red", 500.00);//prices to corresponding colors
    ...
    public void setColor(String c) {//following are setters and getters
        this.color = c;
    }
